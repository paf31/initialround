...
{
    public class UploadTestsCSV : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            if (context.Request.HttpMethod.Equals("POST", StringComparison.OrdinalIgnoreCase))
            {
                ...
                try
                {
                    ...
                    var response = new QuestionService().ParseTestsCSV(new ParseTestsCSVRequest
                    {
                        AuthToken = authToken,
                    ...
                    var serializer = new DataContractJsonSerializer(typeof(ParseTestsCSVResponse));
